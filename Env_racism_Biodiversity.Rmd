...
Percent of census block groups that have:\
...
Percent of census block groups that are:\
- above the 80th percentile for Particulate Matter 2.5 AND above the
80th percentile for Superfund proximity (10 points)
...
Number of census block groups that fall within areas with HOLC grades.
...
Prepare the Dataset for the plotting
