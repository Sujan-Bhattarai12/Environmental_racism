...
tm_shape(LA_redlining)+
    tm_fill(fill = "holc_grade", palette = c("green", "blue", "yellow", 'red'), alpha = 1)+
    tm_shape(result)+
    tm_dots(col = 'percent_of_birds', palette=c('16' ='red', '19'='yellow', '29'='blue', '36' ='green')) + 
    tm_scale_bar(location = c("bottomright"), position = c("left", "bottom"))+
    tm_compass(type = "arrow", position = c("right", "top"))+
  tm_layout(title = "Redlinining areas and avearge bird diversity")
...
Based on the graph, Most A graded areas(green areas in the graph) showed low bird diversity (denoted by red dots) than B, C and D
graded areas. The potential implication of this finding is
that low graded areas offer unique habitat to bird species, thus policy
makers should incorporate these type of findings so that biodiversity protection is ensured. Moreover, this finding challenges the
belief that low graded areas have low species diversity.
